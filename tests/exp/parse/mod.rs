...
fn multi_binop_exprs() {
    assert_mostly_eq!(exp!(exp!(Float(3.7), Star, Float(-4.0)), Minus, Float(2.0)),
                      &parse_exp!("3.7 * -4 - 2"));
    assert_mostly_eq!(exp!(Float(3.7), Star, exp!(Float(-4.0), Minus, Float(-2.0))),
                      &parse_exp!("3.7 * (-4 - 2)"));
    assert_mostly_eq!(exp!(Float(3.7), Plus, exp!(Float(-4.0), Star, Float(2.0))),
                      &parse_exp!("3.7 + -4 * 2"));
    assert_mostly_eq!(exp!(exp!(Float(3.7), Plus, Float(-4.0)), Star, Float(2.0)),
                      &parse_exp!("(3.7 + -4) * 2"));
    ...
    assert_mostly_eq!(exp!(exp!(Float(3.7), Star, exp!(Float(4.0), Plus, Float(2.0))), Star, Float(11.0)),
                      &parse_exp!("(3.7 * (4 + 2) * 11)"));
    assert_mostly_eq!(exp!(Float(3.7), Star, exp!(Float(4.0), Plus, exp!(Float(2.0), Star, Float(11.0)))),
                      &parse_exp!("3.7 * (4 + 2 * 11)"));
    assert_mostly_eq!(exp!(Float(3.7), Star, exp!(exp!(Float(4.0), Plus, Float(2.0)), Star, Float(11.0))),
                      &parse_exp!("3.7 * ((4 + 2) * 11)"));
}
