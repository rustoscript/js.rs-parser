...
fn assign_multi_binop() {
    ...
    assert_mostly_eq!(assign!("_", exp!(Float(3.7), Star, exp!(var!("e_4_4"), Minus, Float(-2.0)))),
    ...
    assert_mostly_eq!(assign!("NUMBER", exp!(exp!(var!("O_k"), Plus, var!("_Ok")), Star, Float(2.0))),
    ...
    assert_mostly_eq!(assign!("num", exp!(exp!(Float(3.7), Star, Float(4.0)), Plus, exp!(Float(2.0), Star, Float(11.0)))),
        &parse_stmt!("num = 3.7 * 4 + 2 * 11;"));
    assert_mostly_eq!(assign!("some_num", exp!(exp!(Float(3.7), Star, exp!(Float(4.0), Plus, Float(2.0))), Star, Float(11.0))),
        &parse_stmt!("some_num = (3.7 * (4 + 2) * 11);"));
    assert_mostly_eq!(assign!("anotherNumber", exp!(Float(3.7), Star, exp!(Float(4.0), Plus, exp!(Float(2.0), Star, Float(11.0))))),
        &parse_stmt!("anotherNumber = 3.7 * (4 + 2 * 11);"));
    assert_mostly_eq!(assign!("e_4_4", exp!(Float(3.7), Star, exp!(exp!(Float(4.0), Plus, Float(2.0)), Star, Float(11.0)))),
